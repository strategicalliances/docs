...
The latest version of the AWS IoT SiteWise Connector requires Mendix Studio Pro version 9.24.2 or above and the AWS Authentication connector version 3.2.0 or higher.
