...
The newest version of the Amazon Translate connector requires Mendix Studio Pro 9.24.2 or above. To authenticate with Amazon Web Service (AWS), you must also install and configure the [AWS authentication connector](https://marketplace.mendix.com/link/component/120333) version 3.2.0 or higher.
