...
To authenticate with Amazon Web Service (AWS), you must also install and configure the [AWS Authentication connector](https://marketplace.mendix.com/link/component/120333). It is crucial for the Amazon Bedrock connector to function correctly. For more information about installing and configuring the AWS Authentication connector, see [AWS Authentication](/appstore/modules/aws/aws-authentication/).

Different versions of the Amazon Bedrock Connector require different versions of the AWS Authentication Connector:
* From version 5.3.0 on, the Amazon Bedrock Connector requires AWS Authentication version 3.2.0. or higher.
* Versions 5.2.1 and lower require AWS Authentication version 3.1.3 or lower.
